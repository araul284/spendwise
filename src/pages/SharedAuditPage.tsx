...
export default function SharedAuditPage() {
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          <div className="w-10 h-10 border border-slate-800 border-t-slate-600 animate-spin mx-auto mb-4" />
  ...
  return (
    <div className="min-h-screen bg-slate-100 text-black">
      {/* Nav */}
      <nav className="sticky top-0 z-50 border-b border-black bg-slate-100/90" style={{ backdropFilter: 'blur(16px)' }}>
